...
#' Define server logic
#' 
#' @param input provided by \link{shinyCell}.
#' @param output provided by \link{shinyCell}.
#' @param session provided by \link{shinyCell}.
#' @import shiny formattable dplyr tidyr magick
